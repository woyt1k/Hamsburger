...
const telegramChannelUrl = 'https://t.me/kreapy_uc' // Замените на ссылку на ваш канал
...
bot.command('start', (ctx) => {
  ctx.reply(
    ...
    Markup.inlineKeyboard([
      Markup.button.url('Перейти в канал', telegramChannelUrl), // Кнопка для перехода в канал
